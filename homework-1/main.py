...
if __name__ == '__main__':
    item1 = Item("Смартфон", 10000, 0.2, 1)  # Добавляем аргумент quantity
    item2 = Item("Ноутбук", 20000, 0.05, 1)  # Добавляем аргумент quantity

    print(item1.calculate_total_price())  # 12000.0
    print(item2.calculate_total_price())  # 19000.0
